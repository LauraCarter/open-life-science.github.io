...
The easiest way to start contributing is to [open an issue](https://github.com/jezcope/ah-software-escape-room/issues/new) to tell
...
8. Pull requests will be merged by the team members after at least one
